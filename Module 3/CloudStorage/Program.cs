...
class Program
{
    private const string connectionString = "DefaultEndpointsProtocol=https;AccountName=psstoor;AccountKey=EynDkZRf28ZGtZwQ2M0XJbsslcHoQ7liFxWphh3gEsNJ3V/oAh7MvJ9BZfgX+5TgaRtQP6G8PPXO+AStNQJ4cg==;EndpointSuffix=core.windows.net";
