...
{
    private const string _connectionString = "AccountEndpoint=https://pscosmonaut.documents.azure.com:443/;AccountKey=6t9ZfV2zVxIoliejQ3H64jeT7Hj2uEPKogL7fAFHyFF5AoEKU0Qbeux4xlAxIDdfeLKWaFuWZyZKACDbw6rDtQ==;";
    ...
    static async Task Main(string[] args)
    {
        ...
        var builder = container.GetChangeFeedProcessorBuilder<BrandDocument>("changes333",
