...
class Program
{
    private static string conStr = "Endpoint=sb://ps-hup.servicebus.windows.net/;SharedAccessKeyName=schrijvert;SharedAccessKey=PAMBUhrvmIKVAiBjuPzqTtvFyjwVo2e8b+AEhC79cL8=;EntityPath=hup";
