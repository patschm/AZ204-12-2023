...
class Program
{
    private const string conStr = "Endpoint=sb://ps-hup.servicebus.windows.net/;SharedAccessKeyName=lezert;SharedAccessKey=iExn4BdNcMQORbVq+ml7beHbAuUeL5dhp+AEhJr+BaE=;EntityPath=hup";
    private const string hubName = "hup";

    private const string checkpointStorage = "DefaultEndpointsProtocol=https;AccountName=psstoort;AccountKey=Wz5jSnIjTV0vi3e9Z47uRZoZgSxNYPmNsvHyIfZgAZZyhaDLbkq7ZG5barMvatRavJ8UEirFCowT+AStsYp/fg==;EndpointSuffix=core.windows.net";
